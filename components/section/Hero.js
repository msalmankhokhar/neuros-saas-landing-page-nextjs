...
export default function Hero() {
    return (
        <section className="maxContainer paddingContainer py-20 flex flex-col gap-6 items-center justify-center">
            ...
            <MotionDiv className="font-medium rounded-full text-center min-351:text-right text-base border shadow-md shadow-secondary-200 border-secondary-400 px-4 py-2 flex gap-2 items-center">
                <BrandIcon />
                <span className="text-xs xs:text-sm text-secondary-700">Generative Business Intelligence for Analysts</span>
            </MotionDiv>

            <MotionDiv element={motion.h1} className="font-bold text-4xl xs:text-5xl max-w-4xl text-center text-secondary-1000 leading-[116%]">
                Revolutionizing Business Decisions with AI-Powered Analytics
            </MotionDiv>

            <MotionDiv element={motion.p} className="text-base text-secondary-600 max-w-2xl text-center">
            ...
            <MotionDiv className="flex flex-col min-351:flex-row self-stretch gap-2 min-351:items-center min-351:justify-center">
